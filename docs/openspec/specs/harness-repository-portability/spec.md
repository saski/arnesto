# harness-repository-portability Specification

## Purpose
Define the stable repository identity, provenance, checkout portability, runtime
boundaries, and migration gates for the Arnesto agent harness.
